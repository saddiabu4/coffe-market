		...
		<div className='bg-primary overflow-hidden w-full h-[505px] flex items-center justify-center'>
			...
			<div className='flex gap-[32px] flex-col items-center justify-center'>
				<div className='flex flex-col items-center gap-[12px]'>
					<h1 className='font-calistoga font-[600] leading-[112%] text-8xl text-secondary w-[680px] h-[108px] text-center sm:text-[48px] md:text-[80px] md:leading-[112%] '>
						Menu
					</h1>
				...
				<div className='flex flex-row items-center justify-center gap-3 sm:flex-col'>
					<Button
						text='Our Locations'
						className='cursor-pointer px-4 py-3 bg-secondary text-primary rounded-3xl font-cabin sm:w-full'
					/>
					<Button
						text='About Us'
						className='cursor-pointer px-4 py-3 rounded-3xl border-1 border-secondary text-secondary sm:w-full'
					/>
				</div>
			</div>
		</div>
